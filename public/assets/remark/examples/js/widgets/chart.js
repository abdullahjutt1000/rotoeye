(function (global, factory) {
  ...
  (function () {
    ...
    var line_time_data = [];
    var line_time_totalPoints = 2880;
    var line_time_updateInterval = 1000000;
    var line_time_now = new Date().getHours()+':'+new Date().getMinutes();

    while (line_time_data.length < line_time_totalPoints) {
      var x = 0;
      line_time_labels.push(line_time_now);
      line_time_data.push(x.toFixed(0));
    ...
    function line_time_getData() {
      ...
      line_time_now = new Date().getHours()+':'+new Date().getMinutes();
