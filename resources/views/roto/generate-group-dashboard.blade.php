                    ...
                    <div class="row row-lg">
                        <div class="col-md-12">
                            <div class="example-wrap">
                                ...
                                <div class="example">
                                    <form action="{{URL::to('/group-dashboard-report')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control" name="machine_id"  data-plugin="select2" data-placeholder="Select Machine" >
                                            ...
                                            <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control" name="company_id"  data-plugin="select2" data-placeholder="Select Company" >
                                            ...
                                            <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control" name="month"  data-plugin="select2" data-placeholder="Select Month" >
                                            ...
                                            <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control" name="business_unit_id"  data-plugin="select2" data-placeholder="Select Business Unit" >
                                                            @foreach($bu as $bu)
                                            ...
                                            <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control" name="department_id"  data-plugin="select2" data-placeholder="Select Department" >
                                            ...
                                            <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control" name="section_id"  data-plugin="select2" data-placeholder="Select Section" >
