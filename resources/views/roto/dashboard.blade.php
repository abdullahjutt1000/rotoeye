                                        ...
                                        <div class="col-6">
                                            <div class="counter counter-md text-left">
                                                ...
                                                <div class="counter-number-group">
                                                    <span
                                                        class="counter-number white">{{ $running_job->product->id }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="counter counter-md text-right">
                                                ...
                                                @if (Session::get('rights') != 3)
                                                    <div class="counter-number-group">
                                                        <a
                                                            href="{{ URL::to('select/job' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}"><span
                                                                class="counter-number white">{{ $running_job->id }}</span></a>
                                                    </div>
                                                @else
                                                    <span class="counter-number white">{{ $running_job->id }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="counter counter-md text-left">
                                                ...
                                                <div class="counter-number-group">
                                                    <span class="counter-number white"
                                                        title="{{ $running_job->product->name }}">{{ substr($running_job->product->name, 0, 30) . ' ...' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-8">
                                            <div class="counter counter-md text-left">
                                                ...
                                                <div class="counter-number-group">
                                                    <span
                                                        class="counter-number white">{{ $record->process && count($record->process->materialCombination($running_job->product->id)) > 0 ? $record->process->materialCombination($running_job->product->id)[0]->name : '' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-5">
                                            <div class="counter counter-md text-left">
                                                ...
                                                <div class="counter-number-group">
                                                    <span class="counter-number white">
                                                        @if ($record->process && count($record->process->materialCombination($running_job->product->id)) > 0)
                                                            @if (
                                        ...
                                        <div class="col-7">
                                            <div class="counter counter-md text-right">
                                                ...
                                                <div class="counter-label grey-200">Job Length
                                                    <small>({{ $record->machine->qty_uom }})</small>
                                                </div>
                                                <div class="counter-number-group">
                                                    <span
                                                        class="counter-number white">{{ number_format($running_job->job_length) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="vertical-align text-center white p-10 h-250" style="background-color: #fcfcfc"
                                ...
                                <div class="counter-number-group vertical-align-middle">
                                    <div class="gauge" id="Gauge" data-plugin="gauge" data-value="870"
                                        data-max-value="{{ $record->machine->max_speed }}" data-stroke-color="#e1e1e1"
                                        style="bottom: 10px;">
                                        <div class="gauge-label"></div>
                                        <div
                                            style="position: absolute;width: 100%;bottom: 1%; color: #000; font-size: 12px">
                                            {{ $record->machine->qty_uom . '/' . $record->machine->time_uom }}</div>
                                        <canvas width="200" height="150"></canvas>
                                    </div>
                                    <div style="color: #336699; position: relative;bottom: 18px;"><strong
                                            id="meters"></strong> {{ $record->machine->qty_uom }}</div>
                                                        ...
                                                        <select class="form-control form-control-sm" data-plugin="select2"
                                                            ...
                                                            @foreach ($rotoErrors as $error)
                                                                @if ($error->category == 'Waste')
                                                                    <option data-category="{{ $error->category }}"
                                                                        value="{{ $error->id }}">
                                                ...
                                                <div class="counter counter-md text-left">
                                                    @if (!$machine->app_type)
                                                        <a class="float-right text-light text-uppercase"
                                                            href="{{ URL::to('/dashboard/manual' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}"><u>Rotoeye
                                                                manual</u></a>
                                                    @endif
                                                    <div class="counter-label grey-200">Machine</div>
                                                    <div class="counter-number-group">
                                                        <span
                                                            class="counter-number white">{{ $record->machine->name . ' - ' . $record->machine->sap_code }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="counter counter-md text-left">
                                                    ...
                                                    <div class="counter-number-group">
                                                        <span
                                                            class="counter-number white">{{ $record->machine->section->department->businessUnit->business_unit_name }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="counter counter-md text-left">
                                                    ...
                                                    <div class="counter-number-group">
                                                        <span
                                                            class="counter-number white">{{ $record->machine->section->department->name }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="counter counter-md text-left">
                                                    ...
                                                    <div class="counter-number-group">
                                                        <span
                                                            class="counter-number white">{{ $record->machine->max_speed . ' ' . $record->machine->qty_uom . '/' . $record->machine->time_uom }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="counter counter-md text-left">
                                                    ...
                                                    <div class="counter-number-group">
                                                        <span
                                                            class="counter-number white">{{ $record->machine->waste_speed . ' ' . $record->machine->qty_uom . '/' . $record->machine->time_uom }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="counter counter-md text-left">
                                                    ...
                                                    <div class="counter-number-group">
                                                        <span
                                                            class="counter-number white">{{ $record->user->name }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 form-group">
                                ...
                                <input type="text" class="form-control" name="slitted_reel_width"
                                    value="{{ isset($running_job->product->slitted_reel_width) ? $running_job->product->slitted_reel_width * 1000 : '' }}"
                                    placeholder="Slitted Reel Width(mm)" disabled>
                            </div>
                            <div class="col-xl-6 form-group">
                                <label>No. of UP's</label>
                                <input type="text" class="form-control" name="ups"
                                    value="{{ isset($running_job->product->ups) ? $running_job->product->ups : '' }}"
                            ...
                            <div class="col-xl-6 form-group">
                                ...
                                <input type="text" class="form-control" name="col"
                                    value="{{ isset($running_job->product->col) ? $running_job->product->col * 1000 : '' }}"
                            ...
                            <div class="col-xl-6 form-group">
                                ...
                                <input type="text" class="form-control" name="gsm"
                                    value="{{ isset($running_job->product->gsm) ? $running_job->product->gsm * 1000 : '' }}"
                            ...
                            <div class="col-xl-6 form-group">
                                ...
                                <input type="text" class="form-control" name="trim_width"
                                    value="{{ isset($running_job->product->trim_width) ? $running_job->product->trim_width * 1000 : '' }}"
                            ...
                            <div class="col-xl-6 form-group">
                                ...
                                <input type="text" class="form-control" name="thickness"
                                    value="{{ isset($running_job->product->thickness) ? $running_job->product->thickness * 1000000 : '' }}"
                            ...
                            <div class="col-xl-6 form-group">
                                ...
                                <input type="text" class="form-control" name="density"
                                    value="{{ isset($running_job->product->density) ? $running_job->product->density : '' }}"
        ...
        <div class="modal fade " id="examplePositionSidebar" aria-hidden="true" aria-labelledby="examplePositionSidebar"
            ...
            <div class="modal-dialog modal-simple modal-sidebar modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <small>Hey <strong>{{ $user->name }}</strong>, your login session has expired for machine
                            <strong>{{ $machine->name . ' - ' . $machine->sap_code }}</strong>. Please login again to
                            continue.</small>
                        <hr>
                        <form action="{{ URL::to('login') }}" method="post" id="loginForm" name="loginForm"
                            class="mt-50">
                            ...
                            <div class="form-group form-material floating" data-plugin="formMaterial"
                                ...
                                <select class="form-control" id="selectMachine" data-plugin="select2" name="machine">
                                    <option value="{{ $machine->id }}" selected>
                                        {{ $machine->name . ' - ' . $machine->sap_code }}</option>
                                </select>
                            </div>
                            ...
                            <a class="btn btn-success btn-sm btn-block btn-lg" href="{{ URL::to('login') }}">Go To Login
                                Page</a>
                        </form>
                    </div>
                </div>
...
@section('footer')
    ...
    <script>
        ...
        window.onload = function() {
            var maximumGraphSpeed = '{!! $record->machine->max_speed !!}';
            var waste_speed = '{!! $record->machine->waste_speed !!}';
            var dps = [];
            var meeter_from = 0;
            @foreach ($graphRecords as $graphRecord)
                dps.push({
                    x: new Date('{{ $graphRecord->run_date_time }}'),
                    y: parseInt('{{ $graphRecord->speed }}'),
                    hidden: {{ $graphRecord->length }}
                });
            @endforeach
            function onClick(e) {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                axisY: {
                    ...
                    minimum: 0,
                    interval: parseInt('{!! $record->machine->max_speed !!}') / 4,
                    stripLines: [{
                        value: parseInt('{!! $record->machine->waste_speed !!}'),
                        label: "Waste Speed"
                    }]
                },
                data: [{
            ...
            var graph_span = parseInt('{!! $record->machine->graph_span !!}') + 10;
            ...
            var updateChart = function(count) {
                ...
                $.ajax({
                    ...
                    async: 'FALSE',
                    data: {
                        machine: "{!! \Illuminate\Support\Facades\Crypt::encrypt($machine->id) !!}"
                    },
                    statusCode: {
        ...
        function changeJob() {
            var machine_id = '{!! $record->machine->id !!}';
            var job_id = $('#selectJob').val();
            $.ajax({
                url: '{!! URL::to('change/job') !!}',
                method: 'POST',
                async: 'FASLE',
                data: {
    ...
    @if (!$machine->app_type)
        <script>
            ...
            function getLatestRecord(machine_id) {
                $.ajax({
                    url: '{!! URL::to('/latest/record/') !!}/' + machine_id,
                    method: 'GET',
                    async: 'FASLE',
                    statusCode: {
                        200: function(response) {
            ...
            $('#manualAllocateDowntime').click(function() {
                ...
                $.ajax({
                    url: '{!! URL::to('/manual/allocate/downtime') !!}',
                    method: 'POST',
                    async: 'FASLE',
                    data: {
