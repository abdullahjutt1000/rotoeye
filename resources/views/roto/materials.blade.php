...
@section('body')
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                All material combinations currently available in Roto Eye
            </ol>
        </div>
                    ...
                    <table class="table table-hover dataTable table-striped w-full" id="exampleTableSearch">
                        ...
                        <tbody>
                            @foreach($materials as $material)
                                <tr>
                                    <td><a href="{{URL::to('material/update'.'/'.\Illuminate\Support\Facades\Crypt::encrypt($machine->id).'/'.$material->id)}}">{{$material->name}}</a></td>
                                    <td>
