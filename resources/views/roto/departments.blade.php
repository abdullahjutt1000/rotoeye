                ...
                <div class="panel-body">
                    <table class="table table-hover dataTable table-striped w-full" id="exampleTableSearch">
                        ...
                        @foreach($departments as $department)
                            <tr>
                                <td><a href="{{URL::to('department/update'.'/'.$department->id.'/'.\Illuminate\Support\Facades\Crypt::encrypt($machine->id))}}">{{$department->id}}</a></td>
                                <td>{{$department->name}}</td>
                                <td>{{$department->businessUnit->business_unit_name}}</td>
                                <td>{{$department->businessUnit->company->name}}</td>
                                <td><a href="{{URL::to('department/delete'.'/'.$department->id)}}"><i class="md-delete"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
