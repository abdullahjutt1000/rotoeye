...
@section('body')
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">All Error Categories</h1>
            <ol class="breadcrumb">
                All Error Categories currently available in Roto Eye
            </ol>
        </div>
        <div class="page-content">
            ...
            <div class="panel">
                <header class="panel-heading">
                    <h3 class="panel-title">Error Categories</h3>
                </header>
                <div class="panel-body">
                    <table class="table table-hover dataTable table-striped w-full" id="exampleTableSearch">
                        <thead>
                            <tr>
                                <th>Error Category ID</th>
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    <td><a
                                            href="{{ URL::to('categories/update' . '/' . $category->id . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">{{ $category->id }}</a>
                                    </td>
                                    <td>{{ $category->name }}</td>

                                    <td><a href="{{ URL::to('categories/delete' . '/' . $category->id) }}"><i
