                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <form autocomplete="off" method="post"
                                        action="{{ URL::to('user/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group form-material col-md-2">
                                                ...
                                                <input type="text" class="form-control" id="employeeID" name="id"
                                                    placeholder="ID" value="{{ old('id') }}" autocomplete="off"
                                                    required />
                                            </div>
                                            <div class="form-group form-material col-md-4">
                                                <label class="form-control-label" for="cnic">CNIC <small>(digits
                                                        only)</small></label>
                                                <input type="text" class="form-control" id="cnic" name="cnic"
                                                    placeholder="CNIC" value="{{ old('cnic') }}" autocomplete="off"
                                        ...
                                        <div class="row">
                                            <div class="form-group form-material col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="designation"
                                                    ...
                                                    placeholder="Designation" maxlength="50" autocomplete="off"
                                                    required />
                                            </div>
                                            <div class="form-group form-material col-md-6">
                                                ...
                                                <select class="form-control" id="rights" name="rights" required>
                                                    ...
                                                    <option value="3">Reporting User</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <li>
                                                    <div class="counter counter-sm text-left">
                                                        <div class="counter-number-group mb-10">
                                                            ...
                                                            <span
                                                                class="counter-number">{{ number_format(($operatorCount / count($users)) * 100, 0) }}</span>
                                                            <span class="counter-number-related">%</span>
                                                        </div>
                                                    </div>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar progress-bar-info bg-blue-600"
                                                            aria-valuenow="{{ ($operatorCount / count($users)) * 100 }}"
                                                            aria-valuemin="0" aria-valuemax="100"
                                                            style="width: {{ number_format(($operatorCount / count($users)) * 100, 0) . '%' }}"
                                                            role="progressbar">
                                                            <span
                                                                class="sr-only">{{ number_format(($operatorCount / count($users)) * 100, 0) }}%</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="counter counter-sm text-left">
                                                        <div class="counter-number-group mb-10">
                                                            ...
                                                            <span
                                                                class="counter-number">{{ number_format(($powerUserCount / count($users)) * 100, 0) }}</span>
                                                            <span class="counter-number-related">%</span>
                                                        </div>
                                                    </div>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar progress-bar-info bg-red-600"
                                                            aria-valuenow="{{ ($powerUserCount / count($users)) * 100 }}"
                                                            aria-valuemin="0" aria-valuemax="100"
                                                            style="width: {{ number_format(($powerUserCount / count($users)) * 100, 0) . '%' }}"
                                                            role="progressbar">
                                                            <span
                                                                class="sr-only">{{ number_format(($powerUserCount / count($users)) * 100, 0) }}%</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="counter counter-sm text-left">
                                                        <div class="counter-number-group mb-10">
                                                            ...
                                                            <span
                                                                class="counter-number">{{ number_format(($adminCount / count($users)) * 100, 0) }}</span>
                                                            <span class="counter-number-related">%</span>
                                                        </div>
                                                    </div>
                                                    <div class="progress progress-xs  ">
                                                        <div class="progress-bar progress-bar-info bg-green-600"
                                                            aria-valuenow="{{ ($adminCount / count($users)) * 100 }}"
                                                            aria-valuemin="0" aria-valuemax="100"
                                                            style="width: {{ number_format(($adminCount / count($users)) * 100, 0) . '%' }}"
                                                            role="progressbar">
                                                            <span
                                                                class="sr-only">{{ number_format(($adminCount / count($users)) * 100, 0) }}%</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="counter counter-sm text-left">
                                                        <div class="counter-number-group mb-10">
                                                            ...
                                                            <span
                                                                class="counter-number">{{ number_format(($reportUserCount / count($users)) * 100, 0) }}</span>
                                                            <span class="counter-number-related">%</span>
                                                        </div>
                                                    </div>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar progress-bar-info bg-red-600"
                                                            aria-valuenow="{{ ($reportUserCount / count($users)) * 100 }}"
                                                            aria-valuemin="0" aria-valuemax="100"
                                                            style="width: {{ number_format(($reportUserCount / count($users)) * 100, 0) . '%' }}"
                                                            role="progressbar">
                                                            <span
                                                                class="sr-only">{{ number_format(($reportUserCount / count($users)) * 100, 0) }}%</span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
