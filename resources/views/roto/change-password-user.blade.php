...
@section('body')
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Changing Password</h1>
            <ol class="breadcrumb">
                            ...
                            <div class="row row-lg">
                                <div class="col-md-12">
                                    <div class="example-wrap">
                                        <div class="example">
                                            <form autocomplete="off" method="post" action="{{URL::to('change/password'.'/'.$user->id.'/'.\Illuminate\Support\Facades\Crypt::encrypt($machine->id))}}">
                                                <div class="row">
