...
@section('body')
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Update Machine</h1>
            <ol class="breadcrumb">
                Update machine as per the requirement.
            </ol>
        </div>
                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <form autocomplete="off" method="post"
                                        action="{{ URL::to('machine/update' . '/' . $machine->id . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}"
                                        enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="form-group form-material col-md-3">
                                                <label class="form-control-label" for="code">Machine Code</label>
                                                <input type="text" class="form-control" id="code" name="code"
                                                    placeholder="Machine Code" value="{{ $machine->sap_code }}"
                                                    autocomplete="off" required />
                                            </div>
                                            <div class="form-group form-material col-md-6">
                                                <label class="form-control-label" for="name">Name</label>
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="Name" value="{{ $machine->name }}" autocomplete="off"
                                                    required />
                                            </div>
                                            <div class="form-group form-material col-md-3">
                                                <label class="form-control-label" for="ip">IP</label>
                                                <input type="text" class="form-control" id="ip" name="ip"
                                                    placeholder="IP" value="{{ $machine->ip }}" autocomplete="off"
                                                    required />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group form-material col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="hw_type" name="hw_type"
                                                    value="{{ $machine->hw_type }}" placeholder="Hardware"
                                                    autocomplete="off" />
                                            </div>
                                            <div class="form-group form-material col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="max_speed" name="max_speed"
                                                    placeholder="Max Speed" value="{{ $machine->max_speed }}"
                                                    autocomplete="off" required />
                                            </div>
                                            <div class="form-group form-material col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="waste_speed"
                                                    ...
                                                    value="{{ $machine->waste_speed }}" autocomplete="off" required />
                                            </div>
                                            <div class="form-group form-material col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="auto_downtime"
                                                    ...
                                                    value="{{ $machine->auto_downtime }}" autocomplete="off" required />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group form-material col-md-8">
                                                ...
                                                <select class="form-control" id="downtime_error" name="downtime_error"
                                                    ...
                                                    @foreach ($error_codes as $error_code)
                                                        @if ($error_code->id == $machine->downtime_error)
                                        ...
                                        <div class="row">
                                            <div class="form-group form-material col-md-3">
                                                ...
                                                <select class="form-control" id="time_uom" name="time_uom" required>
                                                    <option {{ $machine->time_uom == 'Hr' ? 'selected' : '' }}
                                                        value="Hr">Hour</option>
                                                    <option {{ $machine->time_uom == 'Min' ? 'selected' : '' }}
                                                        value="Min">Minute</option>
                                                    <option {{ $machine->time_uom == 'Sec' ? 'selected' : '' }}
                                                        value="Sec">Second</option>
                                                </select>
                                            </div>
                                            <div class="form-group form-material col-md-3">
                                                <label class="form-control-label" for="qty_uom">Qty UOM</label>
                                                <select class="form-control" id="qty_uom" name="qty_uom" required>
                                                    <option {{ $machine->qty_uom == 'Meters' ? 'selected' : '' }}
                                                        value="Meters">Meters</option>
                                                    <option {{ $machine->qty_uom == 'Sheets' ? 'selected' : '' }}
                                                        value="Sheets">Sheets</option>
                                                </select>
                                            </div>
                                            <div class="form-group form-material col-md-6">
                                                ...
                                                <select class="form-control" id="section" name="section" required>
                                                    @foreach ($sections as $section)
                                                        <option
                                                            {{ $machine->section->id == $section->id ? 'selected="Selected"' : '' }}
                                                            value="{{ $section->id }}">
                                        ...
                                        <div class="row">
                                            <div class="form-group form-material col-md-3">
                                                ...
                                                <input type="number" class="form-control" id="graph_span"
                                                    name="graph_span" value="{{ $machine->graph_span }}"
                                            ...
                                            <div class="form-group form-material col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="roller_circumference"
                                                    name="roller_circumference"
                                                    value="{{ $machine->roller_circumference }}"
                                            ...
                                            <div class="form-group form-material col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="roller_circumference"
                                                    name="rh_ip" value="{{ $machine->rh_logger_ip }}"
                                                    placeholder="RH IP" autocomplete="off" />
                                            </div>
                                            {{-- Made fields for updating .Bin Files start by Abdullah  --}}
                                            <div class="form-group col-md-4">
                                                <label class="form-control-label" for="bin_file"
                                                    style="font-weight: 500;">Upload Binfile 1</label>
                                                <input type="file" name="bin_file1" id="bin_file" accept=".bin">
                                                @if ($machine->bin1)
                                                    <a
                                                        href="{{ url('machines/' . $machine->sap_code . '/' . $machine->bin1) }}">
                                                        <p>{{ $machine->bin1 }}</p>
                                                    </a>
                                                @endif
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="file" name="bin_file2" id="bin_file" accept=".bin">
                                                @if ($machine->bin2)
                                                    <a
                                                        href="{{ url('machines/' . $machine->sap_code . '/' . $machine->bin2) }}">
                                                        <p>{{ $machine->bin2 }}</p>
                                                    </a>
                                                @endif
                                            </div>
                                            {{-- Made fields for updating .Bin Files end by Abdullah --}}
                                            ...
                                            <div class="card card-block p-30 bg-green-600">
                                                ...
                                                <div class="counter counter-md counter-inverse text-left">
                                                    <div class="counter-number-group">
                                                        <span class="counter-number">{{ count($machines) }}</span>
                                                        <span
