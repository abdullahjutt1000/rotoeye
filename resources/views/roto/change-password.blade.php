                ...
                <div class="col-md-6" style="height: 100%">
                    <div class="panel">
                        <header class="panel-heading">
                            <h3 class="panel-title">Changing Password for <small>{{$user->name}}</small></h3>
                        </header>
                            ...
                            <div class="row row-lg">
                                <div class="col-md-12">
                                    <div class="example-wrap">
                                        <div class="example">
                                            <form autocomplete="off" method="post" action="{{URL::to('change/password/0')}}">
                                                <div class="row">
                                                    <div class="form-group form-material col-md-4">
                                                        <label class="form-control-label" for="oldPassword">Old Password</label>
                                                        <input type="password" class="form-control" id="oldPassword" name="old_password" value="{{old('old_password')}}" placeholder="Old Password" autocomplete="off" required/>
                                                    </div>
                                                    <div class="form-group form-material col-md-4">
