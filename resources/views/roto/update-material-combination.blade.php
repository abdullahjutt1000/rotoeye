...
@section('body')
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                Update materials as per the required fields.
            </ol>
        </div>
                ...
                <div class="col-md-4" style="height: 100%">
                    <div class="panel">
                        <header class="panel-heading">
                            <h3 class="panel-title"> Update <small>Material Details</small></h3>
                        </header>
                            ...
                            <div class="row row-lg">
                                <div class="col-md-12">
                                    <div class="example-wrap">
                                        <div class="example">
                                            <form autocomplete="off" method="post" action="{{URL::to('update/material'.'/'.$machine->id)}}">
                                                <div class="row">
                                                    <label class="form-control-label" for="material_id">Select Material</label>
                                                    <select class="form-control select2-primary" id="material_id" name="material_id" required>
                                                        @if(isset($materials))
                                                            <option>Select Material Combination</option>
                                                    ...
                                                    <label class="form-control-label" for="combination_id"> Select Similar Materials</label>
                                                    <select class="form-control select2-primary-multiple" id="combination_id[]" name="combination[]" multiple required>
                                                        @if(isset($materials))
                                                            <option>Select Material Combination</option>
                                                            @foreach($materials as $material)
                                                                <option value="{{$material->id}}">{{$material->name}}</option>
...
@section('footer')
    ...
    <script>
        $(document).ready(function() {
            $('.select2-primary-multiple').select2();
        });
    </script>
@endsection
