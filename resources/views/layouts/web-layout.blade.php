            ...
            <ul class="nav navbar-toolbar">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" role="button">
                        ...
                        <span><strong>{{$record ? $record->machine->name.' - '.$record->machine->sap_code:""}}</strong></span>
                    </a>
                </li>
            </ul>
            <!-- End Navbar Toolbar -->
            ...
            <div class="overlay-panel vertical-align overlay-background">
                <div class="vertical-align-middle">
                    <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img src="/assets/global/portraits/{{$record->user->photo}}" alt="...">
                    </a>
        ...
        <div>
            <div>
                <ul class="site-menu" data-plugin="menu">
                    ...
                    <!-- <li class="site-menu-item {{$path == 'downtimewitherrors/update/report{id}' ? 'active':""}}">
                        <a class="animsition-link" href="{{URL::to('downtimewitherrors/update/report'.'/'.\Illuminate\Support\Facades\Crypt::encrypt($machine->id))}}">
                            <i class="site-menu-icon md-collection-text" aria-hidden="true"></i>
                            <span class="site-menu-title">Downtime With Erors Filters</span>
                        </a>
                    </li> -->
                    <!---- mine code ---->
