                    ...
                    <ul class="site-menu" data-plugin="menu">
                        ...
                        <li class="site-menu-item {{ $path == 'productivity/{id}' ? 'active' : '' }}">
                            <a class="animsition-link"
                                href="{{ URL::to('productivity' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                <i class="site-menu-icon md-chart" aria-hidden="true"></i>
                        ...
                        <li class="site-menu-item" {{ $path == 'reports/{id}' ? 'active' : '' }}>
                            <a class="animsition-link"
                                href="{{ URL::to('reports' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li class="site-menu-item {{ $path == 'downtime/update/report{id}' ? 'active' : '' }}">
                            <a class="animsition-link"
                                href="{{ URL::to('downtime/update/report' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                <i class="site-menu-icon md-collection-text" aria-hidden="true"></i>
                                <span class="site-menu-title">Allocate Downtime</span>
                            </a>
                        </li>
                        <li
                            class="site-menu-item has-sub {{ $path == 'downtime/update/{id}' || $path == 'records/update/{id}' ? 'active open' : '' }}">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'downtime/update/{id}' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('downtime/update' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Downtimes</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'records/update/{id}' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('records/update' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Records</span>
                                    </a>
                                </li>
                                <li
                                    class="site-menu-item {{ $path == 'process-structure/update/{id}' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('process-structure/update' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Process Structure</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'records/manual/{id}' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('records/manual' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'users' || $path == 'user/add' || $path == 'user/update/{id}' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'user/add/{id}' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('user/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add User</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'users/{id}' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('users' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'materials' || $path == 'material/add' || $path == 'material/update/{id}' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'material/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('material/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Material</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'materials' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('materials' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'products' || $path == 'product/add' || $path == 'product/update/{id}' || $path == 'product/all' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                ...
                                <li class="site-menu-item {{ $path == 'products' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('products' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'production/orders' || $path == 'production/order/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'companies' || $path == 'company/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'company/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('company/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Company</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'companies' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('companies' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'business-units' || $path == 'business-unit/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                                <i class="site-menu-icon md-square-down" aria-hidden="true"></i>
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'business-unit/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('business-unit/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Business Unit</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'business-units' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('business-units' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'departments' || $path == 'department/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                                <i class="site-menu-icon md-square-down" aria-hidden="true"></i>
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'department/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('department/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Department</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'departments' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('departments' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'sections' || $path == 'section/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                                <i class="site-menu-icon md-square-down" aria-hidden="true"></i>
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'section/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('section/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Section</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'sections' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('sections' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'sleeves' || $path == 'sleeves/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'sleeves/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('sleeves/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Sleeve</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'sleeves' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('sleeves' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                        ...
                        <!-- mine code -->
                        <li
                            class="site-menu-item has-sub {{ $path == 'categories' || $path == 'categories/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                                <i class="site-menu-icon md-square-down" aria-hidden="true"></i>
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'categories/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('categories/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Error Category</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'categories' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('categories' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">All Error Categories</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="site-menu-item {{ $path == 'circuits/update/numberdays{id}' ? 'active' : '' }}">
                            <a class="animsition-link"
                                href="{{ URL::to('circuits/update/numberdays' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                <i class="site-menu-icon md-collection-text" aria-hidden="true"></i>
                        ...
                        <!-- end mine code -->
                        <li
                            class="site-menu-item has-sub {{ $path == 'processes' || $path == 'process/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                                <i class="site-menu-icon md-square-down" aria-hidden="true"></i>
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'process/add' ? 'active' : '' }}">
                                    <a class="animsition-link" href="{{ URL::to('process/add') }}">
                                        <span class="site-menu-title">Add Process</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'processes' ? 'active' : '' }}">
                                    <a class="animsition-link" href="{{ URL::to('processes') }}">
                        ...
                        <li
                            class="site-menu-item has-sub {{ $path == 'error-codes' || $path == 'error-code/add' ? 'active open' : '' }}">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item {{ $path == 'error-code/add' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('error-code/add' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
                                        <span class="site-menu-title">Add Error Code</span>
                                    </a>
                                </li>
                                <li class="site-menu-item {{ $path == 'error-codes' ? 'active' : '' }}">
                                    <a class="animsition-link"
                                        href="{{ URL::to('error-codes' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id)) }}">
