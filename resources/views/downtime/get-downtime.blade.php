                    ...
                    <div class="row row-lg">
                        <div class="col-md-12">
                            <div class="example-wrap">
                                ...
                                <div class="example">
                                    <form action="{{URL::to('downtime/update/report'.'/'.\Illuminate\Support\Facades\Crypt::encrypt($machine->id))}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="example">
