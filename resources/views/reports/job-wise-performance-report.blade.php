                    ...
                    <div class="panel" id="print-panel" style="min-height: 842px">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                <strong>Job Wise Performance Report</strong>
                                @if($shift[0] == 'All-Day')
                        ...
                        <div class="panel-body">
                            <table class="table table-hover dataTable table-striped w-full" id="production-report-table">
                                ...
                                @foreach($records as $row)
                                    <tr>
                                        ...
                                        <td>{{date('M d, Y H:i:s',strtotime($row['from']))}}</td>
                                        <td>{{date('M d, Y H:i:s',strtotime($row['to']))}}</td>
                            ...
                            <div class="row col-12">
                                <div class="col-2">
                                    <u>Running Time:</u> <strong>{{number_format($runningTime, 0)}} min</strong>
                                </div>
                                <div class="col-1"></div>
                                <div class="col-3">
                                    <u>Unplanned Downtime:</u> <strong>{{number_format($unPlannedDowntime, 0)}} min</strong>
                                </div>
                            </div>
                        </div>
