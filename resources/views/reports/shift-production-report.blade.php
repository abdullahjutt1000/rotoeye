                    ...
                    <div class="panel" id="print-panel" style="min-height: 842px">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                <strong>Daily Shift Production Report</strong> - <small>{{isset($from)?$from.' to '.$to:$date}}</small>
                                    ...
                                    @if(isset($records[$i-1]['job_id']))
                                        @if($records[$i]['job_id'] != $records[$i-1]['job_id'])
                                            ...
                                            <tr style="background-color: lightgrey; color: black">
                                                ...
                                                <td>
                                                    <p style="margin-bottom: 0px">Job Production:</p> <strong style="color: darkred;"> {{number_format($records[$i][0]['jobProduction'],0)." ".$machine->qty_uom}}</strong>
                                                </td>
                                                <td colspan="4">
