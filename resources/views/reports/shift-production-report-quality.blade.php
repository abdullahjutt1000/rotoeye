    ...
    <div class="page">
        <div class="page-header">
            <div class="page-header-actions" style="left: 30px">
                ...
                <button
                    onclick="exportTableToExcel('production-report-table', '{{ $machine->sap_code . '-' . $machine->name . ' Shift Production Report' }}')"
                                    ...
                                    @for ($i = 0; $i < count($records); $i++)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ date('H:i', strtotime($records[$i]['from'])) }}<br><small>{{ date('d M, Y', strtotime($records[$i]['from'])) }}</small>
                                            </td>
                                            <td class="text-center">
                                                {{ date('H:i', strtotime($records[$i]['to'])) }}<br><small>{{ date('d M, Y', strtotime($records[$i]['to'])) }}</small>
                                            </td>
                                            <td style="text-align: center">{{ number_format($records[$i]['duration'], 0) }}
                                            </td>
                            ...
                            <div class="row col-12">
                                ...
                                <div class="col-4" style=" text-align: right">
                                    <p style="text-align: right; margin-bottom: 0;"><u>Availability Rate:</u>
                                        <strong>{{ number_format($availability, 2) }} %</strong>
                                    </p>
                                    <p style="text-align: right; margin-bottom: 0;"><u>Availability Rate (EE):</u>
                                        <strong>{{ number_format($availability_ee, 2) }} %</strong>
                                    </p>
