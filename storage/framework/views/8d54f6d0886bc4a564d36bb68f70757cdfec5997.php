                    ...
                    <div class="row row-lg">
                        <div class="col-md-6">
                            <div class="example-wrap">
                                ...
                                <div class="example">
                                    <form
                                        action="<?php echo e(URL::to('/production/report' . '/' . \Illuminate\Support\Facades\Crypt::encrypt($machine->id))); ?>"
                                                ...
                                                <div class="example">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="date"
                                                            value="<?php echo e(date('m/d/Y')); ?>" data-plugin="datepicker" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="example-wrap">
                                                    <div class="example">
                                                        <select class="form-control shiftSelection" name="shiftSelection[]"
                                                            ...
                                                            <?php $__currentLoopData = $machine->section->department->businessUnit->shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($shift->id); ?>">
                                                                    <?php echo e($shift->shift_number); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="example">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="to_date"
                                                            value="<?php echo e(date('m/d/Y')); ?>" data-plugin="datepicker">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                    ...
                                                    <div class="example">
                                                        <select class="form-control" id="operator" name="operator"
                                                            ...
                                                            <?php $__currentLoopData = $operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($operator->id); ?>"><?php echo e($operator->name); ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="example">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="losses_from_date" value="<?php echo e(date('m/d/Y')); ?>"
...
<?php echo $__env->make('layouts.' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotoeye\resources\views/reports/generate-reports.blade.php ENDPATH**/ ?>