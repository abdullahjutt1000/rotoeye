    ...
    <div class="page">
        <div class="page-header">
            <div class="page-header-actions" style="left: 30px">
                ...
                <button
                    onclick="exportTableToExcel('production-report-table', '<?php echo e($machine->sap_code . '-' . $machine->name . ' Shift Production Report TOE'); ?>')"
                    ...
                    <div class="panel" id="print-panel" style="min-height: 842px">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                ...
                                <small><?php echo e(isset($from) ? $from . ' to ' . $to : $date); ?></small>
                                ...
                                <?php endif; ?>
                                <small>Total <?php echo e($machine->qty_uom); ?>:
                                    <strong><?php echo e(number_format($totalLength, 0)); ?></strong></small><br>
                                <small>Day Production: <strong><?php echo e(number_format($produced, 0)); ?></strong></small><br>
                                <small>Day Waste: <strong><?php echo e(number_format($waste, 0)); ?></strong></small><br>
                        ...
                        <div class="panel-body" id="export-panel">
                            ...
                            <table class="table table-hover dataTable table-striped w-full production-report-table">
                                ...
                                <tbody>
                                    <?php for($i = 0; $i < count($records); $i++): ?>
                                        <?php if(isset($records[$i - 1]['job_id'])): ?>
                                            <?php if($records[$i]['job_id'] != $records[$i - 1]['job_id']): ?>
                                                <tr style="background-color:rgb(246,246,0); color: black">
                                                    <td colspan="3">
                                                        <strong>Job No:
                                                        </strong><?php echo e($records[$i]['job_id'] . ' - ' . $records[$i]['product_number']); ?><br>
                                                        <strong>Job Name: </strong><?php echo e($records[$i]['job_name']); ?>

                                                    </td>
                                                    <td colspan="3">
                                                        <strong>Substrate:
                                                        </strong><?php echo e($records[$i]['material_combination']); ?><br><?php echo e($records[$i]['process_name']); ?><br>
                                                        <strong>Color:
                                                        </strong><?php echo e($records[$i]['process_structure_color']); ?>

                                                    </td>
                                                    <td colspan="3">
                                                        <strong>Required:
                                                        </strong><?php echo e(number_format($records[$i]['job_length'], 0) . ' ' . $machine->qty_uom); ?><br>
                                                        <strong>Produced:
                                                        </strong><?php echo e(number_format($records[$i][0]['jobProduction'], 0) . ' ' . $machine->qty_uom); ?><br>
                                                        <strong>Job Waste:
                                                        </strong><?php echo e($records[$i][0]['jobWaste'] . ' ' . $machine->qty_uom); ?>
                                                ...
                                                <tr style="background-color: lightgrey; color: black">
                                                    ...
                                                    <td style="width: 10%;">
                                                        <p style="margin-bottom: 0px">Job Runtime:</p> <strong
                                                            style="color: darkred;">
                                                            <?php echo e(number_format($records[$i][0]['jobRuntime'], 0)); ?>
                                                    ...
                                                    <td>
                                                        <p style="margin-bottom: 0px">Job Production:</p> <strong
                                                            style="color: darkred;">
                                                            <?php echo e(number_format($records[$i][0]['jobProduction'], 0) . ' ' . $machine->qty_uom); ?></strong>
                                                    </td>
                                                    <td colspan="4">
                                                        <p style="margin-bottom: 0px">Job Performance:</p> <strong
                                                            style="color: darkred;">
                                                            <?php echo e(number_format($records[$i][0]['jobPerformance'], 2)); ?>
                                                    ...
                                                    <td colspan="3">
                                                        <p style="margin-bottom: 0px">Average Running Speed:</p> <strong
                                                            style="color: darkred;">
                                                            <?php echo e(number_format($records[$i][0]['jobAverageSpeed'], 0) . ' ' . $machine->qty_uom . '/' . $machine->time_uom); ?></strong>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <tr style="background-color:rgb(246,246,0); color: black">
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    <strong>Color: </strong><?php echo e($records[$i]['process_structure_color']); ?>
                                            ...
                                            <tr style="background-color: lightgrey; color: black">
                                                ...
                                                <td style="width: 10%;">
                                                    <p style="margin-bottom: 0px">Job Runtime:</p> <strong
                                                        style="color: darkred;">
                                                        <?php echo e(number_format($records[$i][0]['jobRuntime'], 0)); ?> min</strong>
                                                </td>
                                                <td>
                                                    <p style="margin-bottom: 0px">Job Production:</p> <strong
                                                        style="color: darkred;">
                                        ...
                                        <?php if(isset($records[$i - 1]['user_id'])): ?>
                                            <?php if($records[$i]['user_id'] != $records[$i - 1]['user_id']): ?>
                                                <tr style="background-color: white; color: darkred">
                                                    <td colspan="8"><strong><?php echo e($records[$i]['user_name']); ?></strong>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <tr style="background-color: white; color: darkred">
                                                <td colspan="8"><strong><?php echo e($records[$i]['user_name']); ?></strong></td>
                                            </tr>
                                        <?php endif; ?>
                                        
                                        <tr style="line-height: 13px">
                                            <td><?php echo e($records[$i]['error_id']); ?></td>
                                            <td style="width: 20%;"><?php echo e($records[$i]['error_name']); ?></td>
                                            <td class="text-center" style="width: 15%">
                                                <?php echo e(date('H:i', strtotime($records[$i]['from']))); ?>

                                                <small>(<?php echo e(date('d M, Y', strtotime($records[$i]['from']))); ?>)</small>
                                            </td>
                                            <td class="text-center" style="width: 15%">
                                                <?php echo e(date('H:i', strtotime($records[$i]['to']))); ?>

                                                <small>(<?php echo e(date('d M, Y', strtotime($records[$i]['to']))); ?>)</small>
                                            </td>
                                            <td style="text-align: center">
                                                <?php echo e(number_format($records[$i]['duration'], 0)); ?>

                                            </td>
                                            <td style="text-align: right"><?php echo e($records[$i]['length']); ?></td>
                                            <td style="width: 35%;"><?php echo e($records[$i]['comments']); ?></td>
                                            <td style="text-align: right">
                                                <small><?php echo e(number_format($records[$i]['instantSpeed'], 1)); ?></small>
                                            </td>
                                        </tr>
                            ...
                            <div class="row col-12">
                                ...
                                <div class="col-3">
                                    ...
                                    <u>Budgeted Time for EE:</u> <strong><?php echo e(number_format($budgetedTime_for_ee, 0)); ?>

                                        min</strong> <br>
                                    <u>Budgeted Time for OEE:</u> <strong><?php echo e(number_format($budgetedTime, 0)); ?>

                                        min</strong> <br>

                                    <u>Budgeted Time for TEE:</u> <strong><?php echo e(number_format($budgetedTime_for_tee, 0)); ?>
                                ...
                                <div class="col-4" style=" text-align: right">
                                    <p style="text-align: right; margin-bottom: 0;"><u>Availability Rate for EE:</u>
                                        <strong><?php echo e(number_format($availability_for_ee, 2)); ?> %</strong>
                                    </p>
                                    <p style="text-align: right; margin-bottom: 0;"><u>Availability Rate for OEE:</u>
                                        <strong><?php echo e(number_format($availability_for_oee, 2)); ?> %</strong>
                                    </p>
                                    <p style="text-align: right; margin-bottom: 0;"><u>Availability Rate for TEE:</u>
                                        <strong><?php echo e(number_format($availability_for_tee, 2)); ?> %</strong>
                                    </p>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script src="<?php echo e(asset('assets/custom/jsPDF.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/custom/html2canvas.js')); ?>"></script>
...
<?php echo $__env->make('layouts.' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotoeye\resources\views/reports/shift-production-report-quality-toe.blade.php ENDPATH**/ ?>