    ...
    <div class="page">
        <div class="page-header">
            <div class="page-header-actions" style="left: 30px">
                ...
                <button onclick="exportTableToExcel('error-history', '<?php echo e($machine->name.'-'.$error->name); ?>')" class="btn btn-sm btn-icon btn-success btn-round" data-toggle="tooltip" data-original-title="Export to Excel">Export to Excel</button>
            </div>
        </div>
                    ...
                    <div class="panel" id="print-panel">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                <strong><?php echo e($error->name); ?> History</strong>
                        ...
                        <div class="panel-body">
                            <table class="table table-hover dataTable table-striped w-full" id="error-history">
                                ...
                                <tr id="errorHistory">
                                    <td><?php echo e(date('d M, Y H:i:s', strtotime($rec['from']))); ?></td>
                                    <td><?php echo e(date('d M, Y H:i:s', strtotime($rec['to']))); ?></td>
                                    <td><?php echo e($rec['error_name']); ?></td>
                                    <td style="width: 30%;"><?php echo e($rec['err_comments']); ?></td>
                                    <td><?php echo e(number_format($rec['duration'],2)); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.'.$layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotoeye\resources\views/reports/error-history-report.blade.php ENDPATH**/ ?>