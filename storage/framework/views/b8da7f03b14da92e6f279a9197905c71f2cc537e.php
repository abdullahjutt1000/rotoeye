...
<?php $__env->startSection('header'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/global/vendor/owl-carousel/owl.carousel.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/global/vendor/slick-carousel/slick.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/remark/examples/css/uikit/carousel.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('assets/global/vendor/nprogress/nprogress.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/remark/examples/css/widgets/chart.css')); ?>">
        ...
        <div class="page-content container-fluid">
            ...
            <div class="example" data-plugin="matchHeight" data-by-row="true">
                <div class="slider" id="exampleMultipleItems">
                    <?php $__currentLoopData = $user->allowedMachines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userMachine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="meterContainer animation-scale-up" id="Machine<?php echo e($userMachine->id); ?>" data-machine="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($userMachine->id)); ?>" data-ip="<?php echo e($userMachine->ip); ?>">
                            <div class="card-group">
                                <div class="card card-block p-0">
                                    <div class="col-12 red-roto">
                                        <div class="counter counter-md text-left">
                                            <div class="counter-number-group">
                                                <form method="POST" action="<?php echo e(URL::to('select/machine')); ?>">

                                                    <input value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($userMachine->id)); ?>" name="machine" hidden>
                                                    <button class=" btn counter-number bg-transparent white" style="margin: 0px; padding: 0px" type="submit"><strong><?php echo e($userMachine->name.' - '.$userMachine->sap_code); ?></strong></button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="vertical-align text-center white p-10" style="background-color: #fcfcfc; height: 280px" id="meter">
                                        <div class="counter-number-group vertical-align-middle">
                                            <div class="gauge" id="Gauge" data-plugin="gauge" data-value="870" data-max-value="<?php echo e($userMachine->max_speed); ?>" data-stroke-color="#e1e1e1" style="bottom: 10px;">
                                                <div class="gauge-label"></div>
                                                <div style="position: absolute;width: 100%;bottom: 1%; color: #000; font-size: 12px"><?php echo e($userMachine->qty_uom.'/'.$userMachine->time_uom); ?></div>
                                                <canvas width="200" height="150"></canvas>
                                            </div>
                                            <div style="color: #336699; position: relative;bottom: 18px;"><strong id="meters"></strong> <?php echo e($userMachine->qty_uom); ?></div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script src="<?php echo e(asset('assets/global/js/Plugin/input-group-file.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/global/vendor/owl-carousel/owl.carousel.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/global/vendor/slick-carousel/slick.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/global/js/Plugin/owl-carousel.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/remark/examples/js/uikit/carousel.js')); ?>"></script>
    <script>
        var machines = [];
...
<?php echo $__env->make('layouts.'.$layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotoeye\resources\views/roto/production-dashboard.blade.php ENDPATH**/ ?>