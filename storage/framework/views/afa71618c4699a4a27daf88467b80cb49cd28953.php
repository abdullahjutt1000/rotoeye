                    ...
                    <div class="panel" id="print-panel">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                <strong>Availability Loss - TEE</strong>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div> <select class="form-control lossesShiftSelection"
                                                                ...
                                                                <?php $__currentLoopData = $machine->section->department->businessUnit->shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shiftts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="col-md-4 example">
                                                        <select class="form-control select2 chk" data-plugin="select2"
                                                            ...
                                                            <option value="availability-losses-toe" selected>% Availability
                                                                Losses - TOE</option>
                                        ...
                                        <?php $__currentLoopData = $graphRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($row['errDuration'] < 10): ?>
                                                <tr id="errorHistory">
                                                    ...
                                                    <td id="availability_loss_toe" style="text-align: center">
                                                        NA
                                                    </td>
                                                    <td style="text-align: center">
                                                        <?php echo e(number_format(($row['errDuration'] / $budgetedTime) * 100, 0)); ?>%
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row" data-plugin="matchHeight" data-by-row="true">
                <div class="col-md-12">
                    <div class="panel" id="print-panel">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                <strong>Availability Loss - EE</strong>
                                <?php if($shift[0] == 'All-Day'): ?>
                                    <small><?php echo e(date('M d, Y', strtotime($from)) . ' to ' . date('M d, Y', strtotime($to))); ?></small><br>
                                    <small><?php echo e($machine->sap_code . ' - ' . $machine->name . ', ' . $machine->section->name . ', Shift '); ?><?php echo e(count($shift) == 1 ? $shift[0] : ''); ?></small><br>
                                <?php else: ?>
            ...
            <div class="row" data-plugin="matchHeight" data-by-row="true">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="panel" id="print-panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover dataTable table-striped w-full" id="production-report-table1">
                                <thead>
                                    <tr>
                                        <th>Error ID</th>
                                        <th>Error Name</th>
                                ...
                                <tbody>
                                    ...
                                    <?php if($report_type == 'short_stops'): ?>
                                        <?php $__currentLoopData = $graphRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(
                                                $row['errDuration'] < 10 &&
                                                    $row['error_toe_category'] !== 'Strategic Losses/Supply Chain Losses' &&
                                                    $row['error_toe_category'] !== 'Planned Losses/Planning or Management Losses'): ?>
                                                <tr id="errorHistory">
                                                    <td id="error_id" data-error-id="<?php echo e($row['error_id']); ?>">
                                                        <a
                                                            href="<?php echo e(URL::to('get/error/history' . '/' . $machine->id . '/' . date('Y-m-d', strtotime($from)) . '/' . date('Y-m-d', strtotime($to)) . '/' . $row['error_id'] . '/' . serialize($shift))); ?>">
                                                            <?php echo e($row['error_id']); ?>

                                                        </a>
                                                    </td>
                                                    <td id="error_name" data-error-name="<?php echo e($row['error_name']); ?>">
                                                        <?php echo e($row['error_name']); ?>

                                                    </td>
                                                    <td id="duration" data-error-duration="<?php echo e($row['errDuration']); ?>">
                                                        <?php echo e(number_format($row['errDuration'], 2)); ?>

                                                    </td>
                                                    <td id="frequency" data-error-frequency="<?php echo e($row['frequency']); ?>">
                                                        <?php echo e($row['frequency']); ?>
            ...
            <div class="row" data-plugin="matchHeight" data-by-row="true">
                <div class="col-md-12">
                    <div class="panel" id="print-panel">
                        <header class="panel-heading">
                            <h3 class="panel-title">
                                <strong>Availability Loss - OEE</strong>
                                <?php if($shift[0] == 'All-Day'): ?>
                                    <small><?php echo e(date('M d, Y', strtotime($from)) . ' to ' . date('M d, Y', strtotime($to))); ?></small><br>
                                    <small><?php echo e($machine->sap_code . ' - ' . $machine->name . ', ' . $machine->section->name . ', Shift '); ?><?php echo e(count($shift) == 1 ? $shift[0] : ''); ?></small><br>
                                <?php else: ?>
            ...
            <div class="row" data-plugin="matchHeight" data-by-row="true">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="panel" id="print-panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover dataTable table-striped w-full" id="production-report-table2">
                                <thead>
                                    <tr>
                                        <th>Error ID</th>
                                        <th>Error Name</th>
                                ...
                                <tbody>
                                    ...
                                    <?php if($report_type == 'short_stops'): ?>
                                        <?php $__currentLoopData = $graphRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($row['errDuration'] < 10 && $row['error_toe_category'] !== 'Strategic Losses/Supply Chain Losses'): ?>
                                                <tr id="errorHistory">
                                                    <td id="error_id" data-error-id="<?php echo e($row['error_id']); ?>">
                                                        <a
                                                            href="<?php echo e(URL::to('get/error/history' . '/' . $machine->id . '/' . date('Y-m-d', strtotime($from)) . '/' . date('Y-m-d', strtotime($to)) . '/' . $row['error_id'] . '/' . serialize($shift))); ?>">
                                    ...
                                    <?php else: ?>
                                        <?php $__currentLoopData = $graphRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($row['error_toe_category'] !== 'Strategic Losses/Supply Chain Losses'): ?>
                                                <tr id="errorHistory">
                                                    <td id="error_id" data-error-id="<?php echo e($row['error_id']); ?>">
                                                        <a
                                                            href="<?php echo e(URL::to('get/error/history' . '/' . $machine->id . '/' . date('Y-m-d', strtotime($from)) . '/' . date('Y-m-d', strtotime($to)) . '/' . $row['error_id'] . '/' . serialize($shift))); ?>">
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        // Fetch data from the table and populate the dynamicData array
        var dynamicData1 = [];
        $('#production-report-table1').find('tr').each(function() {
            var error_id = $(this).find('#error_id').data('error-id');
            var error_name = $(this).find('#error_name').data('error-name');
            var error_frequency = $(this).find('#frequency').data('error-frequency');
            var duration = $(this).find('#duration').data('error-duration');
        ...
        // Check if myChart1 is defined and is an instance of Chart
        if (typeof myChart1 !== 'undefined' && myChart1 instanceof Chart) {
            // Update the chart data with the dynamicData1
            myChart1.data.labels = dynamicData1.map((item) => item.y);
            myChart1.data.datasets[0].data = dynamicData1.map((item) => item.a);
            myChart1.data.datasets[1].data = dynamicData1.map((item) => item.b);
    ...
    <script>
        ...
        // Fetch data from the table and populate the dynamicData2 array
        var dynamicData2 = [];
        $('#production-report-table2').find('tr').each(function() {
            var error_id = $(this).find('#error_id').data('error-id');
            var error_name = $(this).find('#error_name').data('error-name');
            var error_frequency = $(this).find('#frequency').data('error-frequency');
            var duration = $(this).find('#duration').data('error-duration');
        ...
        // Check if myChart2 is defined and is an instance of Chart
        if (typeof myChart2 !== 'undefined' && myChart2 instanceof Chart) {
            // Update the chart data with the dynamicData2
            myChart2.data.labels = dynamicData2.map((item) => item.y);
            myChart2.data.datasets[0].data = dynamicData2.map((item) => item.a);
            myChart2.data.datasets[1].data = dynamicData2.map((item) => item.b);
    ...
    <script>
        ...
        $('#production-report-table1').tableExport({
            headings: true, // (Boolean), display table headings (th/td elements) in the <thead>
            footers: true, // (Boolean), display table footers (th/td elements) in the <tfoot>
            formats: ["xlsx", "csv", "txt"], // (String[]), filetypes for the export
            fileName: "id", // (id, String), filename for the downloaded file
        ...
        $('#production-report-table2').tableExport({
            headings: true, // (Boolean), display table headings (th/td elements) in the <thead>
            footers: true, // (Boolean), display table footers (th/td elements) in the <tfoot>
            formats: ["xlsx", "csv", "txt"], // (String[]), filetypes for the export
            fileName: "id", // (id, String), filename for the downloaded file
...
<?php echo $__env->make('layouts.' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotoeye\resources\views/reports/availability-loss-report-toe.blade.php ENDPATH**/ ?>